...
bool MyNLP::get_nlp_info(Ipopt::Index& n, Ipopt::Index& m, Ipopt::Index& nnz_jac_g,
...
bool MyNLP::get_bounds_info(Ipopt::Index n, Number* x_l, Number* x_u,
...
bool MyNLP::get_starting_point(Ipopt::Index n, bool init_x, Number* x,
...
bool MyNLP::eval_f(Ipopt::Index n, const Number* x, bool new_x, Number& obj_value)
{
...
bool MyNLP::eval_grad_f(Ipopt::Index n, const Number* x, bool new_x, Number* grad_f)
{
...
bool MyNLP::eval_g(Ipopt::Index n, const Number* x, bool new_x, Ipopt::Index m, Number* g)
{
...
bool MyNLP::eval_jac_g(Ipopt::Index n, const Number* x, bool new_x,
...
bool MyNLP::eval_h(Ipopt::Index n, const Number* x, bool new_x,
